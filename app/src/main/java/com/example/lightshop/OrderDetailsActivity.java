...
public class OrderDetailsActivity extends AppCompatActivity {
    ...
    private void cancelOrderOnSupabase(String reason) {
        ...
        String authHeader = "Bearer " + new com.example.lightshop.api.SessionManager(this).getToken();
        ...
        com.example.lightshop.api.SupabaseClient.getApiService().updateDataByColumn(
                "orders",
