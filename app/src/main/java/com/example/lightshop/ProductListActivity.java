...
public class ProductListActivity extends AppCompatActivity {
    ...
    private void fetchWishlistProductIds() {
        ...
        SupabaseClient.getApiService().fetchWishlist(
            ...
            @Override
            public void onResponse(@NonNull Call<List<com.example.lightshop.models.WishlistModel>> call, @NonNull Response<List<com.example.lightshop.models.WishlistModel>> response) {
                if (response.isSuccessful() && response.body() != null) {
            ...
            @Override
            public void onFailure(@NonNull Call<List<com.example.lightshop.models.WishlistModel>> call, @NonNull Throwable t) {}
        });
    }
}
