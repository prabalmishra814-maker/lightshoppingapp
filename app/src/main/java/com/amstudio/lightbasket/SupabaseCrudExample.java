package com.amstudio.lightbasket; // This tells Java which folder this file belongs to. Example: app.folder.name

import android.util.Log; // This lets us print messages to the console for debugging. Example: printing "Hello!"

import com.amstudio.lightbasket.api.SupabaseApiService; // Import the rules for how to talk to Supabase.
import com.amstudio.lightbasket.api.SupabaseClient; // Import the helper that connects us to Supabase.
